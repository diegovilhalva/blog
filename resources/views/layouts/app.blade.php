    ...
    <div :class="open ? 'block': 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
        <div
            ...
            <div>
                ...
                <a href="{{route('about-us')}}" class="hover:bg-blue-600 hover:text-white rounded py-2 px-4 mx-2">Sobre</a>
            </div>
                
            <div class="flex items-center">
                <form action="{{ route('search') }}" method="get">
                    <input name="q" value="{{ request()->get('q') }}"  type="text" class=" w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Pequisar">
                </form>
                @auth
                ...
                @else
                    ...
                    <a href="{{route('register')}}" class="bg-blue-600 text-white rounded py-2 px-4 mx-2">Registrar</a>
                @endauth
            </div>
        </div>
    </div>
