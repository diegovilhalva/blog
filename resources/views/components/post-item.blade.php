    ...
    <div class="bg-white flex flex-col justify-start p-6">
        ...
        {{--@if ($showAuthor)
            <p href="#" class="text-sm pb-3">
                Por <a href="#" class="font-semibold hover:text-gray-800">{{$post->user->name}}</a>, Publicado em
        ...
        <a  href="{{route('view', $post)}}" class="uppercase text-gray-800 hover:text-black">Continue Lendo <i
